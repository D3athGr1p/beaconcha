...
EXPLORER_IMAGE=beacon:local
CONFIG_CHAIN_NAME=mainnet
CONFIG_CL_NODE_HOST=blocx-temp-beacon-1
CONFIG_CL_NODE_PORT=5052
CONFIG_EL_NODE_HOST=blocx-temp-execution-1
...
chain:
  ...
  clConfig:
    ...
    slotsPerEpoch: 32
    secondsPerSlot: 3
    depositChainID: 86996
frontend:
  enabled: true # Enable or disable to web frontend
  debug: false
  # imprint: "./imprint.html"  
  siteDomain: "http://$HOST_IP_ADDRESS:8080"
  siteName: "BLOCX. Validator Explorer" 
  siteSubtitle: "BLOCX. Validator explorer" 
